...
var trendingStars = function () {
			...
			while (1) {
				switch (_context.prev = _context.next) {
					case 0:
						...
						_context.next = 10;
						return agent('GET', 'https://api.github.com/search/repositories?q=language:' + language.value + '&sort=stars&order=desc');
	...
	return function trendingStars(_x) {
